...
const FaqItemComponent: React.FC<FaqItemComponentProps> = ({ item, isOpen, onClick }) => {
    ...
    return (
        <div ref={itemRef} className="spotlight-card faq-item bg-bg-secondary rounded-xl border border-card-border shadow-lg shadow-black/30 overflow-hidden transition-all duration-300 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/20">
            <h2>
                <button
                    onClick={onClick}
...
export function FAQ({ faqs }: FAQProps): React.ReactNode {
  ...
  return (
    <section id="faq" className="faq-section max-w-3xl mx-auto my-24 px-5" aria-labelledby="faq-heading" tabIndex={-1}>
